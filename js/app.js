...
switch (answer1.toLocaleLowerCase()){
    case "yes":
    case "y" :
    alert("correct")
    break;
...
switch (answer2.toLocaleLowerCase()){
    case "yes":
    case "y" :
...
switch (answer3.toLocaleLowerCase()){
    case "yes":
    case "y" :
...
switch (answer4.toLocaleLowerCase()){
    case "yes":
    case "y" :
...
switch (answer5.toLocaleLowerCase()){
    case "yes":
    case "y" :
